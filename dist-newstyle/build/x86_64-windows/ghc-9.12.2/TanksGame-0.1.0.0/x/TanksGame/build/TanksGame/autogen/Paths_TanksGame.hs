...
-- at runtime using the environment variable TanksGame_bindir.
...
-- environment variable TanksGame_libdir.
...
-- using the environment variable TanksGame_dynlibdir.
...
-- runtime using the environment variable TanksGame_datadir.
...
-- using the environment variable TanksGame_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.12.2-4764\\TanksGame-0.1.0.0-inplace-TanksGame"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.12.2-4764"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.12.2-4764\\TanksGame-0.1.0.0"
libexecdir = "C:\\cabal\\TanksGame-0.1.0.0-inplace-TanksGame\\x86_64-windows-ghc-9.12.2-4764\\TanksGame-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "TanksGame_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "TanksGame_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "TanksGame_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "TanksGame_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "TanksGame_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "TanksGame_sysconfdir") (\_ -> return sysconfdir)
